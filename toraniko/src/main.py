...
def test_estimate_factor_returns_normal():
    ...
    mom_df = factor_mom(returns_df.select("symbol", "date", "asset_returns"), trailing_days=1, winsor_factor=0.01).collect()
...
def test_estimate_factor_returns_empty():
    empty_df = model_sample_data()
    print(estimate_factor_returns(empty_df, empty_df, empty_df, empty_df))
    print("test")

if __name__ == "__main__": 
    test_estimate_factor_returns_normal()